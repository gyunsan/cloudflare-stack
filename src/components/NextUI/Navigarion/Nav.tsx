...
export default function Nav({ children }: { children: React.ReactNode }) {
    ...
    const PageTitle = pathSegments.length > 0 ? pathSegments[pathSegments.length - 1] : "";
    ...
    return (
        <div className="flex h-dvh w-full gap-4">
            {/* Sidebar */}
            <SidebarDrawer
                className={cn("min-w-[288px] rounded-lg sticky top-0 h-dvh", { "min-w-[76px]": isCollapsed })}
            ...
            {/*  Settings Content */}
            <div className="w-full max-w-6xl flex-1 p-4 overflow-y-auto">
                {/* Title */}
                <div className="flex items-center gap-x-3">
                    ...
                    <h1 className="text-3xl font-bold leading-9 text-default-foreground capitalize">{PageTitle}</h1>
                </div>
